package com.example.android.pricetracker.Utils;
...
//TODO implement all data parsing methods (image)
...
public class ParsingHelper {
    ...
    //This is the method to correctly parse the review score
    public static String parseReviews(String url) {
        ...
        try {
            ...
            Element priceEl = doc.select("span.a-icon-alt").first();
            String prod = priceEl.text();
